...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>ASUSTOTO | Link Resmi & Panduan Masuk: Tempat Berlindung Paling Aman</title>
        ...
        <meta property="og:title" content="ASUSTOTO | Link Resmi & Panduan Masuk: Tempat Berlindung Paling Aman" />
        ...
        <meta name="twitter:title" content="ASUSTOTO | Link Resmi & Panduan Masuk: Tempat Berlindung Paling Aman" />
      ...
      <style jsx global>{`
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        body{font-family:'Inter',sans-serif;background:#0d0520;color:#e8e8e8;line-height:1.6;overflow-x:hidden}
        a{color:inherit;text-decoration:none}img{max-width:100%;display:block}
        .W{max-width:1240px;margin:0 auto;padding:0 20px}

        /* Top Bar */
        .topbar{background:#150a30;border-bottom:1px solid rgba(191,90,242,.2);font-size:12px;padding:8px 0;color:#aaa}
        .topbar-inner{display:flex;justify-content:space-between;align-items:center}
        .topbar a{color:#bf5af2;transition:.2s}.topbar a:hover{opacity:.8}

        /* Header */
        header{background:#150a30ee;backdrop-filter:blur(16px);border-bottom:1px solid rgba(191,90,242,.2);position:sticky;top:0;z-index:50}
        .hd{display:flex;align-items:center;justify-content:space-between;padding:12px 0;gap:16px}
        .logo{display:flex;align-items:center;gap:10px;font-weight:800;font-size:22px;color:#bf5af2;flex-shrink:0}
        .logo img{width:38px;height:38px;border-radius:12px;border:2px solid #bf5af2}
        .search-bar{flex:1;max-width:520px;display:flex;border:1.5px solid rgba(191,90,242,.2);border-radius:8px;overflow:hidden;background:#1e1040}
        ...
        .search-bar button{background:#bf5af2;color:#0d0520;border:none;padding:0 18px;font-weight:700;cursor:pointer;font-family:inherit;font-size:13px;transition:.2s}
        .search-bar button:hover{background:#9b40d0}
        ...
        .btn-p{background:#bf5af2;color:#0d0520}.btn-p:hover{background:#9b40d0;transform:translateY(-1px)}
        .btn-o{border:1.5px solid rgba(191,90,242,.2);color:#bf5af2;background:transparent}.btn-o:hover{background:rgba(191,90,242,.12)}

        /* Category Nav */
        .catnav{background:#1e1040;border-bottom:1px solid rgba(191,90,242,.2)}
        ...
        .catnav a:hover,.catnav a.act{color:#bf5af2;border-bottom-color:#bf5af2}

        /* Hero */
        .hero-banner{background:linear-gradient(135deg,#bf5af2,#9b40d0);padding:50px 0;position:relative;overflow:hidden}
        ...
        .hero-text .btn-w{background:#fff;color:#0d0520;font-weight:700;padding:12px 26px;border-radius:8px;border:none;cursor:pointer;font-family:inherit;font-size:14px;transition:.2s}
        ...
        /* Stats */
        .stats{background:#150a30;border-bottom:1px solid rgba(191,90,242,.2);padding:22px 0}
        .stats-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:16px;text-align:center}
        .stat-item .sv{font-size:24px;font-weight:800;color:#bf5af2}
        .stat-item .sl{font-size:10px;color:#bbb;text-transform:uppercase;letter-spacing:1.5px}

        /* Sections */
        .sec{padding:50px 0}
        .sec-alt{background:#150a30}
        .sec-head{text-align:center;margin-bottom:36px}
        .sec-head .label{display:inline-block;background:rgba(191,90,242,.12);color:#bf5af2;padding:5px 16px;border-radius:6px;font-size:10px;font-weight:700;text-transform:uppercase;letter-spacing:1.5px;margin-bottom:10px;border:1px solid rgba(191,90,242,.2)}
        ...
        .art-content h3{font-size:20px;font-weight:700;margin-bottom:14px;color:#bf5af2}
        ...
        .art-gallery img{border-radius:10px;border:1px solid rgba(191,90,242,.2);width:100%;height:200px;object-fit:cover}
        .art-tags{display:flex;gap:8px;flex-wrap:wrap;margin-top:12px}
        .art-tag{background:rgba(191,90,242,.12);color:#bf5af2;padding:5px 14px;border-radius:6px;font-size:11px;font-weight:600;border:1px solid rgba(191,90,242,.2)}

        /* Feature Grid */
        .feat-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px}
        .feat-card{background:#1e1040;border:1px solid rgba(191,90,242,.2);border-radius:12px;padding:24px;transition:.3s}
        .feat-card:hover{border-color:#bf5af2;transform:translateY(-4px);box-shadow:0 8px 30px rgba(0,0,0,.3)}
        .feat-card .fi-icon{width:46px;height:46px;border-radius:10px;background:rgba(191,90,242,.12);display:flex;align-items:center;justify-content:center;font-size:20px;margin-bottom:14px}
        ...
        /* CTA */
        .cta-box{background:linear-gradient(135deg,#bf5af2,#9b40d0);border-radius:16px;padding:48px 32px;text-align:center;color:#fff;position:relative;overflow:hidden}
        ...
        .cta-box .btn-w{background:#fff;color:#0d0520;font-weight:700;padding:14px 32px;border-radius:8px;border:none;cursor:pointer;font-family:inherit;font-size:15px;transition:.2s}
        ...
        .bnr-card{border-radius:12px;overflow:hidden;border:1px solid rgba(191,90,242,.2);transition:.3s}
        .bnr-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px rgba(0,0,0,.3);border-color:#bf5af2}
        .bnr-card img{width:100%;height:auto}

        /* FAQ */
        .faq-list{max-width:720px;margin:0 auto}
        .faq-item{background:#1e1040;border:1px solid rgba(191,90,242,.2);border-radius:10px;padding:16px 20px;margin-bottom:8px;cursor:pointer;transition:.2s}
        .faq-item:hover{border-color:#bf5af2}
        .faq-q{font-weight:600;display:flex;justify-content:space-between;align-items:center;font-size:14px;color:#ddd}
        .faq-q span{color:#bf5af2;font-size:18px;font-weight:700}
        .faq-a{margin-top:10px;color:#bbb;font-size:13px;line-height:1.7;border-top:1px solid rgba(191,90,242,.2);padding-top:10px}

        /* Footer */
        footer{background:#150a30;border-top:1px solid rgba(191,90,242,.2);padding:32px 0;font-size:12px}
        .ft-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:30px;margin-bottom:20px}
        .ft-col h4{color:#bf5af2;font-size:14px;margin-bottom:12px}
        .ft-col a{display:block;color:#888;margin-bottom:6px;transition:.2s}.ft-col a:hover{color:#bf5af2}
        .ft-bottom{border-top:1px solid rgba(191,90,242,.2);padding-top:16px;text-align:center;color:#666}
        ...
        <section className="hero-banner"><div className="W">
          <div className="hero-flex">
            <div className="hero-text">
              ...
              <h1>ASUSTOTO | Link Resmi & Panduan Masuk: Tempat Berlindung Paling Aman</h1>
        ...
        <section className="sec sec-alt" id="tentang"><div className="W">
          ...
          <div className="art-row">
            <div className="art-content">
              ...
              <p>ASUSTOTO melalui situs resmi ASUSTOTO mengajak Anda menjelajahi pengalaman digital tanpa batas. Seperti perjalanan wisata yang menyenangkan, mengakses ASUSTOTO memberikan pengalaman yang lancar dan memuaskan dari awal hingga akhir. Server premium kami tersebar di multiple lokasi strategis, memastikan kecepatan akses optimal dari berbagai wilayah Indonesia.</p>
